...
import org.example.repository.OpsDocumentChunkRepository;
...
class DocumentPersistenceServiceTest {
    ...
    void markIndexingSuccessReplacesChunksAndUpdatesStatus() {
        ...
        ArgumentCaptor<List<org.example.entity.OpsDocumentChunk>> chunksCaptor =
                ArgumentCaptor.forClass((Class) List.class);
        verify(chunkRepository).saveAll(chunksCaptor.capture());
        List<org.example.entity.OpsDocumentChunk> savedChunks = chunksCaptor.getValue();
